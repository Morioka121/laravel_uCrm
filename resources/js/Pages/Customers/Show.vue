                  ...
                  <div class="flex flex-wrap -m-2">
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <div type="text" id="name" name="name"
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <div type="text" id="kana" name="kana"
                          class="w-full bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                          {{ customer.kana }}
                        </div>
                      </div>
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <div type="number" id="postcode" name="postcode" @change="fetchAddress"
                          class="w-full bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                          {{ customer.postcode }}
                        </div>
                      </div>
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <div type="text" id="address" name="address"
                          class="w-full bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                          {{ customer.address }}
                        </div>
                      </div>
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <div type="date" id="birthday" name="birthday"
                          class="w-full bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                          {{ customer.birthday }}
                        </div>
                      </div>
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <div id="memo" name="memo" v-html="nl2br(customer.memo)"
