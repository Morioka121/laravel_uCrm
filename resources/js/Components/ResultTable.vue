...
<template>
  <div v-show="data.type === perDay || data.type === perMonth || data.type === perYear" class="lg:w-2/3 w-full mx-auto overflow-auto">
  ...
  <div v-show="data.type === 'decile'" class="lg:w-2/3 w-full mx-auto overflow-auto">
    <table class="table-auto w-full text-left whitespace-no-wrap">
      <thead>
        <tr>
          <th
